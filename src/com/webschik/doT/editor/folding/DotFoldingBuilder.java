package com.webschik.doT.editor.folding;
...
public class DotFoldingBuilder implements FoldingBuilder, DumbAware {
    ...
    private void appendDescriptors(PsiElement psi, List<FoldingDescriptor> descriptors, Document document) {
        ...
        if (DotTokenTypes.COMMENT == psi.getNode().getElementType()) {
        ...
        if (psi instanceof DotBlockWrapper) {
    ...
    private PsiElement getOpenBlockCloseStacheElement(PsiElement psiElement) {
        ...
        if (endOpenStache == null || endOpenStache.getNode().getElementType() != DotTokenTypes.CLOSE) {
            return null;
        }
    ...
    private PsiElement getCloseBlockCloseStacheElement(PsiElement psiElement) {
        ...
        if (endCloseStache == null || endCloseStache.getNode().getElementType() != DotTokenTypes.CLOSE) {
            return null;
        }
